...
# and in the NixOS manual (accessible by running `nixos-help`).
{
  ...
  my.auth.kanidm = {
    ...
    peerHost = "kirby";
    peerReplicationCertificate = "_MH0wDAYDVR0TAQH_BAIwADAOBgNVHQ8BAf8EBAMCBaAwHQYDVR0lBBYwFAYIKwYBBQUHAwEGCCsGAQUFBwMCMB0GA1UdDgQWBBTaOaPuXmtLDTJVv--VYBiQr9gHCTAfBgNVHREEGDAWghRraXJieS5oYXJ0c2ZpZWxkLnh5ejAKBggqhkjOPQQDAgNIADBFAiAJacijiq1153kkoC7k8CsI941hh-zpEsxjwi2EqU4_xwIhAP7pRp42h-O6lu_HGl3ARv0Y6hBBzxrQP9w4FYNAyGcG";
  };
